import $hgUW1$loglevel from "loglevel";
import $hgUW1$pubsubjs from "pubsub-js";



const $b6b7ead0ff4fc04b$var$defaultOptions = {
    debug: false,
    loader: false
};
class $b6b7ead0ff4fc04b$export$2e2bcd8739ae039 {
    constructor(canvas, options = $b6b7ead0ff4fc04b$var$defaultOptions){
        this.canvas = canvas;
        this.logger = (0, $hgUW1$loglevel).getLogger("rattler");
        this.states = [];
        this.running = false;
        this.lastUpdate = 0;
        this.publish = (0, $hgUW1$pubsubjs).publish.bind((0, $hgUW1$pubsubjs));
        this.subscribe = (0, $hgUW1$pubsubjs).subscribe.bind((0, $hgUW1$pubsubjs));
        this.unsubscribe = (0, $hgUW1$pubsubjs).unsubscribe.bind((0, $hgUW1$pubsubjs));
        this.options = {
            ...$b6b7ead0ff4fc04b$var$defaultOptions,
            ...options
        };
        this.handleResize();
...
class $45c54acee950bc97$export$2e2bcd8739ae039 {
    constructor(engine){
        this.engine = engine;
        this.isActive = false;
...
export {$b6b7ead0ff4fc04b$export$2e2bcd8739ae039 as Engine, $45c54acee950bc97$export$2e2bcd8739ae039 as State};
